...
int main() {
	...
	// These are constant and never change unles we change the program.
	constant double COST_PER_CUBIC_FOOT = 0.23; 	// (MATERIAL & FABRICATION COST PER CU FT, OUR COST TO MAKE)
	constant double CHARGE_PER_CUBIC_FOOT = 0.50;   // (Billed invoice amount per cu ft, customer cost)
